      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            />
            <p className="text-sm text-primary-foreground/80 max-w-md mb-6">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-primary-foreground/10 hover:bg-cta rounded-full flex items-center justify-center transition-all hover:scale-110"
              ...
              <a
                href="https://wa.me/5544988468108"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-primary-foreground/10 hover:bg-cta rounded-full flex items-center justify-center transition-all hover:scale-110"
                aria-label="WhatsApp"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="text-sm text-primary-foreground/80 hover:text-cta transition-colors"
                >
                  Início
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <a
                  href="mailto:contato@gruponunca.com.br"
                  className="text-sm text-primary-foreground/80 hover:text-cta transition-colors break-all"
                >
